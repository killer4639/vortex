...
use crate::challenges::kvstore::TxnBody;
...
pub fn parse_typed_message(msg: Message<Value>) -> Result<TypedMessage> {
    ...
    match typ {
        ...
        "txn" => Ok(TypedMessage::Transaction(parse_message(msg)?)),
...
fn main() -> anyhow::Result<()> {
    ...
    for msg in messages {
        ...
        match msg_typ {
            ...
            TypedMessage::Transaction(msg) => challenges::kvstore::transaction(msg, &mut stdout)?,
